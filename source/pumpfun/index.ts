...
async function sendLocalCreateTx(){
    ...
    formData.append("name", "BOBTEST"),
    formData.append("symbol", "BOBPOW"),
    formData.append("description", "Example token created via PumpPortal"),
    formData.append("twitter", "https://x.com/a1lon9"),
    formData.append("telegram", "https://x.com/a1lon9"),
